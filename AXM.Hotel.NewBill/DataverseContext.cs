...
namespace Axm.Xrm.Entities
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="Axm.Xrm.Entities.axm_Bill"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Axm.Xrm.Entities.axm_Bill> axm_BillSet
		{
			get
			{
				return this.CreateQuery<Axm.Xrm.Entities.axm_Bill>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Axm.Xrm.Entities.axm_Guest"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Axm.Xrm.Entities.axm_Guest> axm_GuestSet
		{
			get
			{
				return this.CreateQuery<Axm.Xrm.Entities.axm_Guest>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Axm.Xrm.Entities.axm_Reservation"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Axm.Xrm.Entities.axm_Reservation> axm_ReservationSet
		{
			get
			{
				return this.CreateQuery<Axm.Xrm.Entities.axm_Reservation>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Axm.Xrm.Entities.axm_Room"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Axm.Xrm.Entities.axm_Room> axm_RoomSet
		{
			get
			{
				return this.CreateQuery<Axm.Xrm.Entities.axm_Room>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Axm.Xrm.Entities.axm_Roomtype"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Axm.Xrm.Entities.axm_Roomtype> axm_RoomtypeSet
		{
			get
			{
				return this.CreateQuery<Axm.Xrm.Entities.axm_Roomtype>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="Axm.Xrm.Entities.axm_Service"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Axm.Xrm.Entities.axm_Service> axm_ServiceSet
		{
			get
			{
				return this.CreateQuery<Axm.Xrm.Entities.axm_Service>();
			}
		}
	}
